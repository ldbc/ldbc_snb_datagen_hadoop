...
if [ "$(uname)" == "Darwin" ]; then
  zip -d $LDBC_SNB_DATAGEN_HOME/target/ldbc_snb_datagen-0.3.8-jar-with-dependencies.jar META-INF/LICENSE
fi

$HADOOP_HOME/bin/hadoop jar $LDBC_SNB_DATAGEN_HOME/target/ldbc_snb_datagen-0.3.8-jar-with-dependencies.jar $LDBC_SNB_DATAGEN_HOME/params.ini
