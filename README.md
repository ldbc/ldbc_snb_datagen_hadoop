...
* Use the [Spark-based Datagen](https://github.com/ldbc/ldbc_snb_datagen/) for the BI workload and for the Interactive workload's larger data sets (support coming in 2022).
